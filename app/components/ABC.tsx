...
export default function ABC (): ReactNode {
  ...
  const antecedentValues: string[] = ['Given Direction/task, asked to do something',
  ...
  const peopleValues: string[] = ['Mom', 'Dad', 'Sibling', 'Grandparents', 'Alone', 'Peers']
  const behaviorValues: string[] = ['Refuse to follow directions', 'Makes verbal threats',
  ...
  const durationValues: string[] = ['< 1 min', '1 - 5 min', '5 - 10 min', '10 - 30 min',
    '30 min - 1 hr', '1 - 2 hrs', '2 - 3 hrs', '3+ hrs']

  const intensityValues: string[] = ['Low', 'Medium', 'High']
  const consequenceValues: string[] = ['Verbal Redirection', 'Physical assist/prompt',
  ...
  function toggleSelected (event, scope): void {
    ...
    switch (scope) {
      ...
      case 'behavior':
        ...
        currentState = updateArray(currentState, label)
        if (label === 'Other') {
          user.behaviorOtherLabelDisabled = !state.user.behaviorOtherLabelDisabled
        }
      ...
      case 'consequence':
        ...
        currentState = updateArray(currentState, label)
        if (label === 'Other') {
          user.consequenceOtherLabelDisabled = !state.user.consequenceOtherLabelDisabled
        }
                ...
                <div id="abcChecklist">
                    <div className="row">
                        <div className="col-md-1">
                            <h4>When?</h4>
                            <hr/>
                            <input className="btn btn-primary" onClick={getTime}
                        ...
                        <div className="col-md-4">
                                  ...
                                  return <div className="radio" key={i}>
                                        <label>
                                            <input type="radio" value={antecedent}
                                                   ...
                                                   checked={state.user.antecedent === antecedent}/>{antecedent}
                                        </label>
                                    </div>
                                })
                            }
                            <div className="radio">
                                <label>
                                    <input type="radio"
                                           ...
                                           value="Other"
                                           onClick={antecedentRadios}/> Other
                                </label>
                            </div>
                            ...
                            <br/>
                            {
                                locationValues.map((location, i) => {
                                  return <div className="radio-inline"
                                                key={i}>
                                        <label>
                                            <input type="radio" onClick={locationRadios}
                            ...
                            <br/>
                            <CheckboxSeries labels={peopleValues} selected={state.user.people}
                            ...
                            setOtherLabelChange={(event) => { setOtherLabelChange(event, 'people') }}
                            toggleSelected={(event) => { toggleSelected(event, 'people') }}/>
                        </div>
                        <div className="col-md-3">
                            <h4>Behavior</h4>
                            <hr/>
                            <b>Select all that apply</b>
                            <CheckboxSeries labels={behaviorValues}
                                            ...
                                            setOtherLabelChange={(event) => { setOtherLabelChange(event, 'behavior') }}
                                            toggleSelected={(event) => { toggleSelected(event, 'behavior') }}/>
                            <br/> <b>Duration</b>
                            <br/>
                            {
                                durationValues.map((duration, i) => {
                                  return <div className="radio-inline" key={i}>
                                        <label>
                                            <input type="radio" onClick={durationRadios}
                            ...
                            <br/>
                            {
                                intensityValues.map((intensity, i) => {
                                  return <div className="radio-inline" key={i}>
                                        <label>
                                            <input type="radio" onClick={intensityRadios}
                        ...
                        <div className="col-md-4">
                            ...
                            <br/>
                            <CheckboxSeries labels={consequenceValues}
                                            ...
                                            setOtherLabelChange={(event) => { setOtherLabelChange(event, 'consequence') }}
                                            toggleSelected={(event) => { toggleSelected(event, 'consequence') }}/>
                        </div>
                    </div>
                    <br/>
                    <div className="form-inline">
                        <div className="form-group">
                            <input className="btn btn-success form-control" type="submit"
                                   onClick={save} value="Save" id="save"/>
                        </div>
                        <div className="form-group">
