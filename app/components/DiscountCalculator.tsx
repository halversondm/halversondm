...
export default function DiscountCalculator(): ReactNode {
  ...
  function calculate(): void {
    discountCalculatorService.validate(
      state.discount1,
      state.discount2,
      state.labelPrice,
    );
  ...
  return (
    <div>
      ...
      <p>
        Calculate your final price where the retailer is offering separate
        discounts.
      </p>
      <fieldset>
        <form className="form-horizontal" role="form">
          <div className="form-group">
            <label htmlFor="labelPrice" className="col-sm-2 control-label">
              Label Price
            </label>
          ...
          <div className="form-group">
            <label htmlFor="discount1" className="col-sm-2 control-label">
              Discount #1
            </label>
            <div className="col-sm-10">
              <div className="input-group">
          ...
          <div className="form-group">
            <label htmlFor="discount2" className="col-sm-2 control-label">
              Discount #2
            </label>
            <div className="col-sm-10">
              <div className="input-group">
