  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>66,500 miles</li>
        <li>
          Purchased 9/29/2000 from Randy Reed Buick Pontiac GMC in Kansas City,
          Missouri
        </li>
        <li>Power Windows</li>
        ...
        <li>
          KYB Struts with higher rate GM springs, Rear springs are from an
        ...
        <li>
          Custom cat-back exhaust with Flowmaster 40 series mufflers and chrome
          round tips
        </li>
        ...
        <li>Matching front, rear and side red badges by Reflective Concepts</li>
        <li>Disabled Daytime Running Lights</li>
        <li>Optima Yellow Top Battery</li>
        <li>Mobil 1 oil and transmission fluid</li>
        <li>
          Non-Smoker car.&nbsp; Driven but not abused. NEVER been to the track.
        </li>
      </ul>
      <PhotoGallery
        perPage={9}
