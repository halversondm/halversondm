  ...
  return (
            <div>
                ...
                <textarea className="form-control" id="encodeInput"
                          ...
                          onChange={setEncodeInput} required={true}/>
                                </div>
                            </div>
                            <div className="form-group">
                ...
                <textarea className="form-control" id="encodeOutput"
                          value={base64State.encodeOutput} readOnly={true}/>
                                </div>
                            </div>
                            <div className="form-group ">
                                <div className="col-sm-offset-2 col-sm-10">
                                    <button id="encode" className="btn btn-primary btn-sm"
                                            onClick={goEncode} type="button">Encode
                                    </button>
                                    <button className="btn btn-danger btn-sm"
                                            onClick={clearEncode} type="button">Clear
                                    </button>
                                </div>
                            </div>
                        </form>
                ...
                <textarea className="form-control" id="decodeInput"
                          ...
                          onChange={setDecodeInput} required={true}/>
                                </div>
                            </div>
                            <div className="form-group">
                ...
                <textarea className="form-control" id="decodeOutput"
                          value={base64State.decodeOutput} readOnly={true}/>
                                </div>
                            </div>
                            <div className="form-group ">
                                <div className="col-sm-offset-2 col-sm-10">
                                    <button id="decode" className="btn btn-primary btn-sm"
                                            onClick={goDecode} type="button">Decode
                                    </button>
                                    <button className="btn btn-danger btn-sm"
                                            onClick={clearDecode} type="button">Clear
                                    </button>
                                </div>
                            </div>
                        </form>
