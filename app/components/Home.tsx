    ...
    <div>
      ...
      <div className="row">
        <div className="col-md-3">
          ...
          <p>
            <Link className="btn btn-info" to="/auto" role="button">
              View details &raquo;
            </Link>
          </p>
        </div>
        <div className="col-md-3">
          ...
          <p>
            <Link className="btn btn-info" to="/apps" role="button">
              View details &raquo;
            </Link>
          </p>
        </div>
        <div className="col-md-3">
          ...
          <p>
            <Link className="btn btn-info" to="/resume" role="button">
              View details &raquo;
            </Link>
          </p>
        </div>
        <div className="col-md-3">
          ...
          <p>
            <Link className="btn btn-info" to="/blog" role="button">
              View details &raquo;
            </Link>
          </p>
        </div>
