            ...
            <div>
                ...
                <div className="row">
                    <div className="col-xs-12 col-sm-6 col-md-8 btn-group img-responsive"
                         role="group" id="human">
                        <p>Your Pick</p>
                        <button id="rock" onClick={human} data-choice="rock"
                                type="button" className={state.rock}>
                            <img src="../images/rock.jpg"/>
                        </button>
                        <button id="paper" onClick={human} data-choice="paper"
                                type="button" className={state.paper}>
                            <img src="../images/paper.jpg"/>
                        </button>
                        <button id="scissors" onClick={human} data-choice="scissors"
                                type="button" className={state.scissors}>
                            <img src="../images/scissors.jpg"/>
                        </button>
                        <button id="lizard" onClick={human} data-choice="lizard"
                                type="button" className={state.lizard}>
                            <img src="../images/lizard.jpg"/>
                        </button>
                        <button id="spock" onClick={human} data-choice="spock"
                                type="button" className={state.spock}>
                    ...
                    <div className="col-xs-6 col-md-4">
                        ...
                        <div id="alert_placeholder">
                            <div className="alert alert-success" role="alert"
                                 hidden={state.gameSuccess}><b>{state.winner}</b>
                                <br/>{state.explanation}
                            </div>
                            <div className="alert alert-warning" role="alert"
                                 hidden={state.gameDraw}><b>{state.winner}</b>
                                <br/>{state.explanation}
                            </div>
                            <div className="alert alert-danger" role="alert"
                                 hidden={state.gameLose}><b>{state.winner}</b>
                                <br/>{state.explanation}
                            </div>
                        </div>
                    </div>
                    <div className="col-xs-12 col-sm-6 col-md-8 btn-group img-responsive"
                        ...
                        <p>Computers Pick</p>
                        <button id="Rock2" type="button" className={state.rock2}
                                disabled={true}>
                            <img src="../images/rock.jpg"/>
                        </button>
                        <button id="Paper2" type="button" className={state.paper2}
                                disabled={true}>
                            <img src="../images/paper.jpg"/>
                        </button>
                        <button id="Scissors2" type="button" className={state.scissors2}
                                disabled={true}>
                            <img src="../images/scissors.jpg"/>
                        </button>
                        <button id="Lizard2" type="button" className={state.lizard2}
                                disabled={true}>
                            <img src="../images/lizard.jpg"/>
                        </button>
                        <button id="Spock2" type="button" className={state.spock2}
                                disabled={true}>
                            <img src="../images/spock.jpg"/>
                        </button>
                    </div>
