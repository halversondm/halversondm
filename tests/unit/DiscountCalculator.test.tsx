...
describe("Discount Calculator", () => {
  ...
  it("Will test a discount with $100, 80% first and 20% second to equal $16", async () => {
    ...
    expect(
      screen.getByText("Your final price is $16.00 plus tax"),
    ).not.toBeNull();
  });
  ...
  it("Will test a discount with $100, 80% first and 0% second to equal $20", async () => {
    ...
    expect(
      screen.getByText("Your final price is $20.00 plus tax"),
    ).not.toBeNull();
  });
  ...
  it("Will test a discount with $100 and no discounts", async () => {
    ...
    expect(
      screen.getByText("Discount #1 is required and must be a number"),
    ).not.toBeNull();
  });
  ...
  it("Will with no input", async () => {
    ...
    expect(
      screen.getByText("Label price is required and must be a number"),
    ).not.toBeNull();
    expect(
      screen.getByText("Discount #1 is required and must be a number"),
    ).not.toBeNull();
