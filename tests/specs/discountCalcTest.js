...
describe("Discount Calculator Test", () => {
    ...
    it("No Discount", () => {
        ...
        const error = browser.getText("li=Discount #1 is required and must be a number");
    ...
    it("No Data Entered, Calculate", () => {
        ...
        const error1 = browser.getText("li=Label price is required and must be a number");
        assert.equal(error1, "Label price is required and must be a number");

        const error2 = browser.getText("li=Discount #1 is required and must be a number");
